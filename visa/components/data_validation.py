#validate both train and test data
import os
import sys
...
#getting the data from data ingestion artifact and then we are validating
    def __init__(self, data_validation_config: DataValidationConfig,
        ...
        try:
            ...
            #define schema file path that we have defined in config_entity
            self.schema_path = self.data_validation_config.schema_file_path
            
            #define train test ingested data, calling from raw_data_validation file
            #dataingestionartifact here bcoz we stored the ingested  data under artifact
            #need to validate both the data
            #validating whatever fn we have define under ingesteddatavalidation class

            #define ingested train and test data
...
#checking the data folder(ingested) if it is available
...
#validating the function that we defined in raw datavalidation file  for both the datasets
#calling ever functions to validate both train and test data
    ...
    def initiate_data_validation(self):
        try:
            #we have to paas the things that are defined in artifact_entity
